            ...
            return (
                <div id="productViewDiv">
                    ...
                    <NavBar />
                        ...
                        <img id="productImage" src={this.state.productInfo.imgUrl} alt="kill_your_gorilla6" alt="err" width="700" height="700" />
                        ...
                        <div id="productInfo">  
                        <center><label id="productTitle"><textarea rows="2" id="updateTitle" rows="1" cols="18" type="text" value={this.state.updateTitle} onChange={e => this.onChange(e)} ></textarea></label></center>

                            <div id="description">
                            <textarea id="updateDesc" rows="15" cols="46" type="text" value={this.state.updateDesc} onChange={e => this.onChange(e)} ></textarea>
                            </div>
