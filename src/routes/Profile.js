...
export default class Profile extends React.Component {
    ...
    render() {
        ...
        <div>
            <NavBar/>
                <center><h3 id="userPic"><img class="profilePic" src={profilePic} alt="kill_your_gorilla6" alt="err" width="480" height="480" /></h3></center>
                ...
                <center><Button id="btnChange" onClick={() => this.onSubmit()} type="submit">Change</Button></center>
