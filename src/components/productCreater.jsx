...
export default class productCreater extends React.Component {
    ...
    onSubmit = () => {
        //price, imgUrl, productDesc, productName
        ...
        if(isAdmin==="false"){notify.showError("Admin Only")}
        else if(price===""){
        ...
        product.createProduct(price, imgUrl, productDesc, productName).then((userData) => {
            ...
            notify.showInfo("Product Created Succesfully!");
    ...
    render() {
        ...
        return (
            ...
            <div class="productCreater">
                ...
                <p><button2 onClick={() => this.onSubmit()} >Create</button2></p>
            </div>
